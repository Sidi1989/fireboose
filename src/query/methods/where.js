 ...
 * On the other hand, when the query refers to just one of the object fields, 
 * there are two solutions:
 *    -create an additional array for the Docs, containing the value of those fields; 
 *    or
 *    -store the object itself as a sub-collection, instead of an element of an array
 * 
